    	...
    	<div class="row-fluid">
        	<div class="span12">
        		<div class="invoice_logo">
        			...
        			<div class="span12" style="text-align:center"><h3><?php if($type == 1) echo "Officer's"; elseif($type == 2) echo "Staff's";?> Basic Salary Information</h3></div>
        		</div>
        	</div><!--span6-->
		</div>
		<table class="table table-bordered table-invoice-full">
			<thead>
				<tr>
					...
					<th class="head1 right">Remarks</th>
				</tr>
			</thead>
			<tbody>
