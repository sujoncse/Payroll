		...
		<table class="table table-bordered table-invoice-full">
			<tbody>
				...
				<tr>
					...
					<td style="text-align:left"><?php echo $designations[$employee["Employee"]["designation_id"]]; if($salary["Employee"]["status"] == 2) echo " (AC)"; elseif($salary["Salary"]["status"] == 3) echo " (CC)";?></td>
				</tr>
				<tr>
