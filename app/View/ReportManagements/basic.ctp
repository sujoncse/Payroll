...
<?php } ?>
<h4 class="widgettitle"><?php if($type == 1) echo "Officer's"; elseif($type == 2) echo "Staff's";?> basic salary information for the month of <?php echo date('F, Y', $curdate); ?></h4>
<table class="table table-bordered" id="salary">
    <thead>
        <tr>
            ...
            <th class="head1 right"><a href="<?php echo $this->webroot."reportManagements/basicPdf/". $type ."/Basic_".date('F, Y').".pdf";;?>" class="btn btn-primary">Generate Report</a></th>
        </tr>
    </thead>
    <tbody>
    	<?php 
