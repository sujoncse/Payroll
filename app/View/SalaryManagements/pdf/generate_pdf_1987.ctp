    	...
    	<div class="row-fluid">
        	<div class="span12">
				<table class="table table-invoice-full">
              		...
              		<tr><td colspan="5" style="text-align:center; font-size:14px"><strong>New Airport Road, Farmgate, Dhaka</strong></td></tr>
              		<tr><td colspan="5" style="text-align:center; font-size:14px"><strong>www.barc.gov.bd</strong></td></tr>
              		<tr><td colspan="5" style="text-align:center; font-size:14px"><strong><?php if($salary["Salary"]["grade"] < 11){ echo "Officer's Salary Bill"; }elseif($salary["Salary"]["grade"] > 10){ echo "Staff's Salary Bill"; } ?></strong></td></tr>
              		<tr>
              		...
              		<tr>
						...
						<td class="width25"><strong><?php echo $salary["PayScale"]["scale"]," - ".$salary["PayScale"]["increment"]." X ".$salary["PayScale"]["increment_iteration"]; if($salary["PayScale"]["eb"] > 0) echo " - EB - ".$salary["PayScale"]["eb"]." X ".$salary["PayScale"]["eb_iteration"];?></strong></td>
					</tr>
					<tr>
