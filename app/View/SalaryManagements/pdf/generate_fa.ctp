	...
	<div class="contentinner">
    	<div class="row-fluid">
        	<div class="span12">
        		...
        		<div style="text-align:center"><h1><?php if($salary["Employee"]["grade"] < 11) echo "Officer's Festival Bill"; else echo "Staff's Festival Bill";?></h1></div>
        	</div><!--span6-->
        </div>
        <div class="row-fluid">
        	<div class="span12">
		        <table class="table table-bordered table-invoice-full">
		        	<tr>
						...
						<td class="width30"><strong>New Airport Road, Farmgate, Dhaka - 1215</strong></td>
		      		</tr>
					<tr>
						<td>Designation:</td>
						<td><?php echo $designations[$salary["FestivalAllowance"]["designation_id"]]; if($salary["FestivalAllowance"]["status"] == 4) echo " (AC)"; elseif($salary["FestivalAllowance"]["status"] == 5) echo " (CC)";?></td>
						<td>Pay Slip #</td>
						<td><strong><?php echo $salary["FestivalAllowance"]["id"];?></strong></td>
					</tr>
					<tr>
						<td>Employee ID:</td>
						<td><?php echo $fa["Employee"]["employee_code"];?></td>
						<td>Pay Scale</td>
						<td><strong><?php echo $fa["PayScale"]["scale"]," - ".$fa["PayScale"]["increment"]." X ".$fa["PayScale"]["increment_iteration"]; if($fa["PayScale"]["eb"] > 0) echo " - EB - ".$fa["PayScale"]["eb"]." X ".$fa["PayScale"]["eb_iteration"];?></strong></td>
					</tr>
					<tr>
						<td>For the month of:</td>
						<td><strong> <?php echo date('F, Y', strtotime(date('Y-m')."month")); ?></strong></td>
						<td>Issue Date:</td>
