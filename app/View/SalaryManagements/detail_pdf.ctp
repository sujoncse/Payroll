				...
				<table class="table table-bordered table-invoice-full">
					...
					<tbody>
						...
						<tr>
							...
							<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
							<td class="right"><?php if(!empty($salary["Deduction"]["hv_interest"])) echo number_format($salary["Deduction"]["hv_interest"])."/-"; else echo "-";?></td>
						</tr>
						<tr>
							<td>Domestic Aid</td>
			...
			<div class="span12">
				<table class="table table-bordered table-invoice-full" style="font-size:13px">
		      		...
		      		<tr>
						...
						<td class="width1">&nbsp;</td>
						<td colspan="3" style="align:center"><img class="img" src="<?php echo $this->webroot."img/stamp.jpg"?>" width="50px" height="50px"/></td>
					</tr>
					<tr>
