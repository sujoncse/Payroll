 ...
 * */
 ...
 echo $this->Form->create('Fixation',array('url'=>array('controller'=>'salaryManagements','action'=>'chargeRelease',$id),"class"=>"stdform stdform2",'id'=>'chargeRelease'));
	...
	<div>
    	<div class="widgetcontent bordered shadowed nopadding">
			<p><label><img src="<?php echo $this->webroot."img/admin/star.png"; ?>"/>Designation</label>
				<span class="field">
					<?php echo $this->Form->input('designation_id',array("id"=>"desId","type"=>"text",'error' => false,"data-placeholder"=>"Choose a Country...","class"=>"chzn-select","style"=>"width:280px","onchange"=>"getEmp()",'label'=>false,'div'=>false,"tabindex"=>"1","value"=>$designations[$this->data["Charge"]["charged_designation"]],"readonly"=>"true"));?>
				</span>
			</p>
			...
			<p id="employee"><label><span class="rad_star"><img src="<?php echo $this->webroot."img/admin/star.png"; ?>"/></span>Taken</label>
				<span class="field">
					<?php echo $this->Form->input('taken',array("id"=>"taken","type"=>"text",'error' => false,"data-placeholder"=>"Choose an employee...","class"=>"chzn-select","style"=>"width:280px",'label'=>false,'div'=>false,"tabindex"=>"3","value"=>date("j'S M, Y",$this->data["Charge"]["taken"]),"readonly"=>"true"));?>
				</span>
			</p>
			<p id="statusDate">
