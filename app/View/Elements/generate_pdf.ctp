...
<div class="maincontent" <?php if($i>=1) echo 'style="page-break-before: always;"'; ?>>
    <div class="contentinner">
        <div class="row-fluid">
            <div class="span12">
                <div class="invoice_logo"><!--<img class="" src="<?php echo $this->webroot;?>img/logo_t.jpg" alt="BARC" width="20%"/>--><img class="" src="<?php echo $this->webroot;?>img/logo.png" alt="BARC" width="100%"/></div>
                <br/>
                ...
                <table class="table table-bordered table-invoice-full" style="font-size:13px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>|</td>
							<td>House Rent <?php //if(empty($deputations[$i]["Deputation"]["house_rent_deduct"])) echo " 7.5% "; else echo " Fixed ";?></td>
                            <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
        ...
        <div class="row-fluid" style="line-height:10px">
            <div class="span12">
                <div class="footer">
                    ...
                    <div class="footerleft" style="margin-left: 260px;">Copyright © 2016 <a href="http://www.barc.gov.bd" target="new"><strong>Bangladesh Agricultural Research Council</strong></a></div>
					<br/><br/>
					<!--<div style="text-align:center;font-size:10px;">Phone: +880-2-9135587, +880-2-9110842; Fax: +880-2-9128061, +880-2-8110924<br />
					E-mail: ec-barc@barc.gov.bd, info@barc.gov.bd; Website: www.barc.gov.bd
					</div>-->
			   </div>
            </div>
        </div>	
