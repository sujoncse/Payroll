        ...
        <div class="row-fluid">
            <div class="span12">
                <table class="table table-bordered table-invoice-full" style="font-size:11px">
                    ...
                    <tr>
                        <td>Month:</td>
                        <td><strong> <?php echo date('F Y', strtotime(date('Y-m',$salary["GeneratedSalary"]["execution_date"])."+0 month")); ?></strong></td>
                        <td>E-TIN:</td>
                ...
                <table class="table table-bordered table-invoice-full" style="font-size:13px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
							<td class="right"><?php if(!empty($salary["GeneratedDeduction"]["cpf_loan1"]) ) { echo number_format($salary["GeneratedDeduction"]["cpf_loan1"])."/-"; }
														elseif(!empty($salary["GeneratedDeduction"]["cpf_loan2"])) { echo number_format($salary["GeneratedDeduction"]["cpf_loan2"])."/-"; }
														else{ echo "-"; }?></td>
						</tr>
                        <tr>
