 ...
 * */
 ...
 echo $this->Html->css(array("admin/datepicker"));
 	echo $this->Form->create('Loan',array('url'=>array('controller'=>'loanManagements','action'=>'updateLoan',$id),"class"=>"stdform stdform2",'id'=>'add'));
 	echo $this->Form->hidden('id');
?>

<h4 class="widgettitle">Loan Update</h4>
<div class="widgetcontent bordered shadowed nopadding">
	<div>
    	<div class="widgetcontent bordered shadowed nopadding">
			<p><label><img src="<?php echo $this->webroot."img/admin/star.png"; ?>"/>Designation</label>
				<span class="field">
					<?php echo $this->Form->input('designation_id',array("id"=>"desId","type"=>"select",'error' => false,"data-placeholder"=>"Choose a Country...","class"=>"chzn-select","style"=>"width:280px","onchange"=>"getEmp()",'label'=>false,'div'=>false,"tabindex"=>"1","options"=>$designations,"readonly"=>true));?>
			...
			<p id="employee"><label><span class="rad_star"><img src="<?php echo $this->webroot."img/admin/star.png"; ?>"/></span>Employee</label>
				<span class="field">
					<?php echo $this->Form->input('employee_id',array("id"=>"empId","type"=>"select",'error' => false,"data-placeholder"=>"Choose an employee...","class"=>"chzn-select","style"=>"width:280px",'label'=>false,'div'=>false,"tabindex"=>"2","options"=>$employees,"value"=>$this->data["Loan"]["employee_id"],"readonly"=>true));?>
			...
			<p><label><span class="rad_star"><img src="<?php echo $this->webroot."img/admin/star.png"; ?>"/></span>Loan Type</label>
				<span class="field">
					<?php echo $this->Form->input('type',array("id"=>"type","type"=>"select",'error' => false,"data-placeholder"=>"Choose an employee...","class"=>"chzn-select","style"=>"width:280px",'label'=>false,'div'=>false,"tabindex"=>"3","options"=>$loanType,"readonly"=>true));?>
		    ...
		    <p>
		        ...
		        <span class="field">
		        	<?php echo $this->Form->input('interest_installment',array("id"=>"interestInstallment",'error' => false,"type"=>"text","class"=>"input-xlarge","placeholder"=>"Interest Installment",'label'=>false,'div'=>false, "tabindex"=>"10"));?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Total Interest : <?php echo round($this->data["Loan"]["total"]*$this->data["Loan"]["total_installment"]/500,0); ?></b>
			...
			<p>
				...
				<span class="field">
					<?php //echo $this->Form->checkbox('status', array('value' => 555)); 
					$options = array('0' => 'Yes', '1' => 'No');
					$attributes = array('legend' => false,'id'=>'status');
