 ...
 * */
 ...
 echo $this->Form->create('Employee',array('url'=>array('controller'=>'employeeManagements','action'=>'editEmployee',$type,$id),"class"=>"stdform stdform2",'id'=>'edit'));
	...
	<div id="basic">
		...
		<div class="widgetcontent bordered shadowed nopadding">
		    ...
		    <p>
				<label>Type</label>
				<span class="field">
		        	<input type="radio" name="Employee[type]" id="type" <?php if($this->data["Employee"]["type"] == 1) echo "checked";?> value="1" style="opacity: 1;" tabindex="17"/> Officer &nbsp; &nbsp;
		            <input type="radio" name="Employee[type]" id="type" value = "2" <?php if($this->data["Employee"]["type"] == 2) echo "checked";?> style="opacity: 1;" tabindex="18"/> Staff
		        </span>
			</p>
		    <p>
	...
	<div id="personal" style="display:none">
		...
		<div class="widgetcontent bordered shadowed nopadding">
			...
			<p>
				<label>Gender</label>
				<span class="field">
		        	<input type="radio" name="EmployeePersonal[gender]" checked="checked" id="gender" <?php if($this->data["EmployeePersonal"]["gender"] == 1) echo "checked";?> value="1" style="opacity: 1;" tabindex="17"/> Male &nbsp; &nbsp;
		            <input type="radio" name="EmployeePersonal[gender]" id="gender" value = "2" <?php if($this->data["EmployeePersonal"]["gender"] == 0) echo "checked";?> style="opacity: 1;" tabindex="18"/> Female
		        </span>
			</p>
			<p>
				<label>Marital Status</label>
				<span class="field">
					<input type="radio" name="EmployeePersonal[marital_status]" id="marital_status" <?php if($this->data["EmployeePersonal"]["marital_status"] == 1) echo "checked";?> onclick="married()"  value = "1" tabindex="19"/>
					Married
					<input type="radio" name="EmployeePersonal[marital_status]" id="marital_status" <?php if($this->data["EmployeePersonal"]["marital_status"] == 0) echo "checked";?> value = "0" onclick="married()" tabindex="20"/>
					Unmarried
				</span>
			</p>
			<p>
				...
				<span class="field">
					<input type="radio" name="EmployeePersonal[children]" <?php if($this->data["EmployeePersonal"]["children"] == 1) echo "checked";?> id="children" value="1" tabindex="21"/>
					One (01)
					<input type="radio" name="EmployeePersonal[children]" <?php if($this->data["EmployeePersonal"]["children"] == 2) echo "checked";?> id="children" value = "2" tabindex="22"/>
					More then One (> 01)
					<input type="radio" name="EmployeePersonal[children]" <?php if($this->data["EmployeePersonal"]["children"] == 0) echo "checked";?> id="children" value="0" tabindex="23"/>
					None
				</span>
			</p>
			<p>
	...
	<div id="salary" style="display:none">
		...
		<div class="widgetcontent bordered shadowed nopadding">
			...
			<p>
				...
				<span class="field">
					<input type="radio" name="EmployeePersonal[house_rent]" id="house_rent" <?php if($this->data["EmployeePersonal"]["house_rent"] == 1) echo "checked";?>  value="1" tabindex="41"/>
					Yes
					<input type="radio" name="EmployeePersonal[house_rent]" id="house_rent" <?php if($this->data["EmployeePersonal"]["house_rent"] == 0) echo "checked";?> value="0" tabindex="42"/>
					No
				</span>
			</p>
			<p>
				...
				<span class="field">
					<input type="radio" name="EmployeePersonal[conveyance]" id="conveyanceR" <?php if(isset($this->data["EmployeePersonal"]["conveyance"]) AND $this->data["EmployeePersonal"]["conveyance"] == 1) echo "checked='checked'";?> value="1" tabindex="42"/>
					Yes 
					<input type="radio" name="EmployeePersonal[conveyance]" id="conveyanceR" <?php if(isset($this->data["EmployeePersonal"]["conveyance"]) AND $this->data["EmployeePersonal"]["conveyance"] == 0) echo "checked='checked'";?> value="0" tabindex="42"/>
					No
				</span>
			</p>
			<p>
				...
				<span class="field">
					<input type="radio" name="EmployeePersonal[association]" id="association" <?php if(isset($this->data["EmployeePersonal"]["association"]) AND $this->data["EmployeePersonal"]["association"] == 1) echo "checked='checked'";?> value="1" tabindex="43"/>
					Yes 
					<input type="radio" name="EmployeePersonal[association]" id="association" <?php if(isset($this->data["EmployeePersonal"]["association"]) AND $this->data["EmployeePersonal"]["association"] == 0) echo "checked='checked'";?> value="0" tabindex="43"/>
					No
				</span>
			</p>
			<p class="stdformbutton">
