...
--
-- Host: localhost
-- Generation Time: Oct 22, 2013 at 05:31 AM
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `other_quota_status` text COLLATE utf8_unicode_ci,
...
INSERT INTO `employees` (`id`, `user_id`, `employee_code`, `first_name`, `middle_name`, `last_name`, `basic`, `joining_date`, `grade`, `joining_grade`, `designation_id`, `joining_designation`, `service_status`, `other_quota_status`, `quota_status`, `status`, `created`, `updated`, `terminal`) VALUES
(1, 1, 'GIS0109201301', 'Rajib', '', 'Mahmud', '0', 1377993600, 4, 0, 4, 0, 1, NULL, NULL, 1, 1379410686, 1379410686, '::1'),
(2, 1, 'GIS0201001', 'Siddik', 'Ur', 'Rahman', '0', 430617600, 20, 0, 65, 0, 1, NULL, NULL, 1, 1380083571, 1380083571, '::1'),
(3, 1, 'GIS001', 'Rajib', '', 'Mahmud', '0', 1152144000, 5, 6, 11, 18, 1, '', NULL, 1, 1382349147, 1382349147, '::1');
...
INSERT INTO `employee_personals` (`id`, `employee_id`, `nid`, `present_address`, `permanent_address`, `cell`, `other_number`, `email`, `f_name`, `m_name`, `s_name`, `s_profession`, `bank`, `account`, `blood_group`, `religion`, `dob`, `gender`, `marital_status`, `children`, `house_rent`, `status`, `created`, `updated`, `terminal`) VALUES
(1, 3, '12345678901234567', 'Dhaka', 'Dhaka', '01755578981', '', 'rajcse048@gmail.com', 'Md. Abdul Alim', 'Mrs. Salina Aktar', '', NULL, 'Agrani Bank Ltd.', '2801218000001', 5, 1, 1835913600, 1, 0, 0, 0, 1, 1382349147, 1382349147, NULL);
...
INSERT INTO `salaries` (`id`, `user_id`, `designation_id`, `employee_id`, `grade`, `basic`, `house_rent`, `medical`, `pp`, `edu`, `charge`, `dearness`, `conveyance`, `tiffin`, `washing`, `deputation`, `aid`, `sumptuary`, `arrear`, `miscellaneous`, `fraction_increment`, `cpf1`, `cpf2`, `arrear_cpf`, `cpf_loan1`, `cpf_loan2`, `house_loan`, `vehicle_loan`, `cpf_interest`, `hv_interest`, `benevolent_fund`, `house_rent_deduct`, `transport_bill`, `personal_vehicle`, `group_insurance`, `w_s`, `fuel`, `overdrawn`, `phone_bill`, `tax`, `miscellaneous_deduct`, `total_add`, `total_sub`, `payable`, `in_word`, `status`, `created`, `updated`, `terminal`) VALUES
(1, 1, 4, 1, 4, 22000, 11900, 700, 500, 300, 1200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1833, 550, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1000, 15, NULL, NULL, NULL, NULL, NULL, NULL, 36600, 3398, 33202, '', 1, 1380188822, 1380188822, '::1'),
(2, 1, 4, 1, 4, 23000, 11900, 700, NULL, 200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1916, 575, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, NULL, NULL, NULL, NULL, NULL, NULL, 35800, 2506, 33294, 'BDT thirty three thousand two hundred ninety four ', 1, 1380604030, 1380604030, '::1');
