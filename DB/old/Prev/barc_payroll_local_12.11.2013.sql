...
--
-- Host: localhost
-- Generation Time: Nov 12, 2013 at 10:50 AM
...
(1, 1, 11, 1, 1, 0, 3444, 1034, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, 15, NULL, NULL, NULL, NULL, NULL, NULL, 4543, '', 1, 1382524793, 1384110102, '::1'),
...
(1, 1, 4, '3000', 1, 'GIS001', 'Rajib', '', 'Mahmud', 1356998400, 4, 6, 4, 18, 1, '', NULL, 1, 1382432836, 1384235448, '::1'),
...
CREATE TABLE IF NOT EXISTS `fixations` (
  ...
  `terminal` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='basic salary settings' AUTO_INCREMENT=4 ;
...
(1, 1, 1, 1383436800, 7840, 3, 3, '7700', 7, 1, 1384109355, 1384109355, '::1'),
(2, 1, 1, 1384041600, 26925, 5, 2, '4500', 9, 1, 1384164682, 1384164682, '::1');
...
(1, 1, 1, 1, 4, 28000, 20670, 700, NULL, 200, 1320, 6000, NULL, NULL, NULL, NULL, NULL, 900, NULL, NULL, NULL, 71130, 66587, 'BDT sixty six thousand five hundred eighty seven.', 2, 1383027103, 1384235448, '::1'),
