...
--
-- Host: localhost
-- Generation Time: Oct 23, 2013 at 03:58 PM
...
(1, 1, 11, 1, 1, 0, 2228, 669, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, NULL, NULL, NULL, NULL, NULL, NULL, 2912, '', 1, 1382524793, 1382524793, '::1');
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `increment` decimal(10,0) NOT NULL,
...
INSERT INTO `employees` (`id`, `user_id`, `pay_scale_id`, `increment`, `employee_code`, `first_name`, `middle_name`, `last_name`, `joining_date`, `grade`, `joining_grade`, `designation_id`, `joining_designation`, `service_status`, `other_quota_status`, `quota_status`, `status`, `created`, `updated`, `terminal`) VALUES
(1, 1, 5, '4500', 'GIS001', 'Rajib', '', 'Mahmud', 1356998400, 5, 6, 11, 18, 1, '', NULL, 1, 1382432836, 1382432836, '::1');
...
(1, 1, 11, 1, 5, 26750, 13375, 700, NULL, 200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 41025, 38113, 'BDT thirty eight thousand one hundred thirteen.', 1, 1382524793, 1382524793, '::1');
